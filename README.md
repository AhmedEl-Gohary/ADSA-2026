# CSEN 1038: Advanced Data Structures and Algorithms (ADSA)

> **Welcome to CSEN 1038 at the German University in Cairo (GUC).** This course aims to introduce some indispensable concepts in data structures and algorithms, which are not only helpful in coding interviews, but also in solving real-life computer science problems.

---

## Course Overview
We will build upon the foundations taught in the CSEN 301 course and CSEN 703 Analysis and Design of Algorithms.
...
* **Study Materials:** Please note that the lecture slides are intended primarily as a quick reference and aid to the presenter. For a deeper understanding of the topics, always check the references section at the end of the slides. There, you will find detailed YouTube video explanations by the instructors, alongside other highly recommended online resources. You are strongly encouraged to utilize these supplementary materials rather than relying exclusively on the lecture.
---

## Assignments, Labs & Grades
* **Platform:** All assignments and labs are hosted on Codeforces. 
* **Action Required:** Access the group here: [Codeforces Group](https://codeforces.com/group/xncV9lPiUu/). **Make sure to join as a participant.**
* **Grades:** You can track your attendance and grades throughout the semester here: [Student Grades](https://docs.google.com/spreadsheets/d/1hcPKplXPH3Xhe_Eenfw7dNlsjZHaRFz_19jCOo-6Msw/edit?gid=0#gid=0).

---

## Evaluation Methods
All assignments will be evaluated by the instructors.
...
### 1. Data Structures
* Introduction to Data Structures & Segment Trees
